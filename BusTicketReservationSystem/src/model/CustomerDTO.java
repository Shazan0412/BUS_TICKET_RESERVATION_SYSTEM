...
public class CustomerDTO {
	...
	public CustomerDTO(int busId, String firstName, String lastName, String mobile, int busNo, String bName,
	...
	public String toString() {
		return "CustomerDTO [BusId=" + BusId + ", firstName=" + firstName + ", lastName=" + lastName + ", mobile=" + mobile
